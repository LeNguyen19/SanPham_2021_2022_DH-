...
namespace Export
{
    public class ExcelExport_DanhSachVe
    {
        #region ---- Constants ----
        ...
        public const string T_DanhSachVeXe = "DanhSachVeXe";
        #endregion
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_DanhSachVeXe:
                    ...
                    arrByte = File.ReadAllBytes("DanhSachVeXe.xlsx").ToArray();
                    break;
                #endregion
            }
            // Get stream
        ...
        public bool ExportDanhSachVe(List<Model_DanhSachVe> dataSource, ref string fileName, bool isPrintPreview)
        {
            // Check if data is null
            ...
            return OutSimpleReport(dataSource, replacer, "DanhSachVeXe", isPrintPreview, ref fileName);
        }
