...
import XuLy.XMLDOMParser;

public class TinTucActivity extends AppCompatActivity {

    ListView listView;
    ArrayList<String> arrayList, arrayList_link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(TinTucActivity.this, ShowTinTucActivity.class);
                intent.putExtra("linkTT", arrayList_link.get(i));
    ...
    private class ReadRss extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            for (int i=0;i<nodeList.getLength();i++){
                ...
                arrayList_link.add(parser.getValue(element, "link"));
